...
public class ArticleDetailsIm extends ArticleDetails {
    public String iid;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ArticleDetailsIm)) return false;
        ArticleDetailsIm that = (ArticleDetailsIm) o;
